...
Функция ПоместитьВоВременноеХранилищеНаСервере()
	//Замечание 4. В документе График отпусков при передаче таблицы в форму анализ графика при помещении во временное хранилище не следует указывать уникальный идентификатор формы т.к. из хранилища данные необходимо получить только один раз.
