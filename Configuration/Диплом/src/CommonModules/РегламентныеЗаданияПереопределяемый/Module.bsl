...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
    //{ Подсисема ВКМ_: добавляем регламентное задание ВКМ_РегламентноеЗадание в интерфейс БСП
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ВКМ_РегламентноеЗаданиеОтравитьВсеСообщенияВГруппуТелеграмм;
	//
КонецПроцедуры
